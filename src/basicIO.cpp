...
extern "C" long syscall3(long number, long arg1, long arg2, long arg3) {
    if (number == 1) { // SYS_WRITE
        return write(static_cast<int>(arg1), reinterpret_cast<void*>(arg2), static_cast<size_t>(arg3));
    } else if (number == 0) { // SYS_READ
        return read(static_cast<int>(arg1), reinterpret_cast<void*>(arg2), static_cast<size_t>(arg3));
    }
    return -1;
}
#else
